...
type NetworkpoliciesundodeploymentStoreSuite struct {
	suite.Suite
...
func TestNetworkpoliciesundodeploymentStore(t *testing.T) {
	suite.Run(t, new(NetworkpoliciesundodeploymentStoreSuite))
}

func (s *NetworkpoliciesundodeploymentStoreSuite) SetupTest() {
...
func (s *NetworkpoliciesundodeploymentStoreSuite) TearDownTest() {
	if s.pool != nil {
		s.pool.Close()
	}
...
func (s *NetworkpoliciesundodeploymentStoreSuite) TestStore() {
	ctx := sac.WithAllAccess(context.Background())
