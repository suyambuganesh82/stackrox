...
func Test_matchesAuthData(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equalf(t, tt.want, matchesAuthData(tt.args.this, tt.args.other), "matchesAuthData(%v, %v)", tt.args.this, tt.args.other)
		})
	}
}
